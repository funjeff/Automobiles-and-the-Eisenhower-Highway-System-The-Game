...
public class SpriteParser {
	...
	/**
	 * creates a sprite parser with only one paramiter
	 * @param parameter the paramiter
	 * @param irrelevent a irrelvent argument to make it diffrent than the filepath one
	 */
	public SpriteParser (String parameter, int irrelevent) {
		parameters = new ArrayList<String>();
